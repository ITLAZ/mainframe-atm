...
public class cambioPIN extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setLabelFor(jPasswordField3);
        jLabel1.setText("CONFIRMAR NUEVO PIN");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        int oldPIN = Integer.parseInt(String.valueOf(jPasswordField2.getPassword()));
        int newPIN = Integer.parseInt(String.valueOf(jPasswordField1.getPassword()));
        int newPINV = Integer.parseInt(String.valueOf(jPasswordField3.getPassword()));
        Funciones f = new Funciones();
        if(newPIN == newPINV && f.cambioPIN(oldPIN, newPIN) && oldPIN != newPIN){
            JOptionPane.showMessageDialog(rootPane, "Cambio de pin realizado exitosamente", "CONFIRMACION", JOptionPane.INFORMATION_MESSAGE);
        } else{
            JOptionPane.showMessageDialog(rootPane, "No se pudo efectuar el cambio de PIN", "ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }                                        
